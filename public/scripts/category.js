...
document
  .querySelector("#sortList>ul>li:nth-child(1)")
  .addEventListener("click", aTozSort);
document
  .querySelector("#sortList>ul>li:nth-child(2)")
  .addEventListener("click", zToaSort);
document
  .querySelector("#sortList>ul>li:nth-child(3)")
  .addEventListener("click", lowSort);
document
  .querySelector("#sortList>ul>li:nth-child(4)")
